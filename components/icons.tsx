...
export const SearchIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M6 2C3.79086 2 2 3.79086 2 6C2 8.20914 3.79086 10 6 10C8.20914 10 10 8.20914 10 6C10 3.79086 8.20914 2 6 2ZM0 6C0 2.68629 2.68629 0 6 0C9.31371 0 12 2.68629 12 6C12 7.29583 11.5892 8.49572 10.8907 9.47653L15.7071 14.2929L14.2929 15.7071L9.47653 10.8907C8.49572 11.5892 7.29583 12 6 12C2.68629 12 0 9.31371 0 6Z"
      fill="currentColor"
    ></path>
  </svg>
);
...
export const EyeOffIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      ...
      <path d="M1 12s4-8 11-8c.88 0 1.73.09 2.54.26"></path>
      <path d="M15 12a3 3 0 0 1-2.83 2.98"></path>
    </svg>
  );
};
